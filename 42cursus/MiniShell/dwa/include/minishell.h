...
/*   Updated: 2024/06/10 13:20:29 by vamologl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		**empty_void_token(t_base *base, int j);
char		***gest_dollar_multipipe(t_base *base, int j);
int			check_empty_tab(t_base *base);
...
int			ft_left_redir(char **av, t_base *base, int j, int i);
...
void		ft_double_lredir(t_base *base, int j, int i);
